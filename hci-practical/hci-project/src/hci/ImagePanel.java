...
public void loadProject(SerializableImage image, Hashtable<String, ArrayList<Point>> polygons, ArrayList<Point> polygon) throws Exception {
	...
	public void findIndex(ArrayList<Point> polygon,Point pt){
	...
	public void mouseClicked(MouseEvent e) {
		...
		//the way the mouse events are handled depends on whether the remove, add or adjust button have been clicked
